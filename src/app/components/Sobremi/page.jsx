  ...
  return (
    ...
    <main className="flex  flex-col items-center justify-between md:flex-col md:justify-around gap-10 sm:gap-20">
        ...
        <div className='w-10/12 m-4 overflow-hidden rounded-3xl md:w-1/2'>
            ...
            <p className='animate-fade-left animate-once animate-duration-1000 animate-delay-500 animate-ease-out animate-normal animate-fill-backwards p-4 text-gray-400 text-2xl'>He formado parte de diversos proyectos de creación de aplicaciones web, tanto en solitario como en equipo. Estas experiencias me han permitido adquirir un valioso aprendizaje y desarrollar habilidades sólidas en tecnologías de desarrollo.</p>
        </div>
        </div>
